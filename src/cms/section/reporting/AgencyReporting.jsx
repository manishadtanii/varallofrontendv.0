...
const AgencyReporting = ({ sectionData, onSave, onBrowseLibrary }) => {
  const [isEditing, setIsEditing] = useState(false);
  const [showReference, setShowReference] = useState(false);
  const fileInputsRef = useRef({});

  console.log("AgencyReporting sectionData:", sectionData);

  // Map backend sectionData -> local content shape
  const mapSectionToContent = (sd) => ({
    tag: sd?.name || "TVG Reporting",
    heading: sd?.title || "Advanced Insights for Informed Decisions",
    desc: sd?.para || "Comprehensive reporting solutions for your organization.",
  ...
  React.useEffect(() => {
    console.log('📌 AgencyReporting received sectionData:', sectionData);
                  ...
                  try {
                    ...
                    for (const key of filesToCheck) {
                      ...
                      if (file && file instanceof File) {
                        ...
                        const res = await uploadAPI.uploadImage(file, 'hero', 'tvg-reporting');
