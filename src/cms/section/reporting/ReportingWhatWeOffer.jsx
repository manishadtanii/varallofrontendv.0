...
const ReportingWhatWeOffer = ({ sectionData, onSave, onBrowseLibrary }) => {
  const [isEditing, setIsEditing] = useState(false);
  const [showReference, setShowReference] = useState(false);
  const fileInputsRef = useRef({});

  console.log("ReportingWhatWeOffer sectionData:", sectionData);
  ...
  React.useEffect(() => {
    console.log('📌 ReportingWhatWeOffer received sectionData:', sectionData);
  ...
  useEffect(() => {
    const handler = (e) => {
      ...
      if (!fieldName.startsWith('c') || !fieldName.endsWith('Icon')) return;
                  ...
                  try {
                    ...
                    for (const key of iconKeys) {
                      ...
                      if (file && file instanceof File) {
                        ...
                        const res = await uploadAPI.uploadImage(file, 'tvgEffect', 'tvg-reporting');
                    ...
                    console.log('💾 ReportingWhatWeOffer final payload:', payload);
...
export default ReportingWhatWeOffer;
