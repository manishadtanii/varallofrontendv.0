...
const ReportingTestimonials = ({ sectionData, onSave }) => {
  const [isEditing, setIsEditing] = useState(false);

  console.log("ReportingTestimonials sectionData:", sectionData);
  ...
  React.useEffect(() => {
    console.log('📌 ReportingTestimonials received sectionData:', sectionData);
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    console.log('💾 ReportingTestimonials final payload:', payload);
...
export default ReportingTestimonials;
