...
const VerifyServiceOverview = ({ sectionData, onSave, onBrowseLibrary }) => {
  ...
  React.useEffect(() => {
    console.log('📌 VerifyServiceOverview received sectionData:', sectionData);
  ...
  console.log("VerifyServiceOverview content:", content);
                ...
                onClick={async () => {
                  try {
                    ...
                    if (content.imageFile && content.imageFile instanceof File) {
                      ...
                      const res = await uploadAPI.uploadImage(content.imageFile, 'overview', 'tvg-verify');
                    ...
                    console.log('💾 VerifyServiceOverview final payload:', payload);
...
export default VerifyServiceOverview;
