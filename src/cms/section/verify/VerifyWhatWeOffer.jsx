...
const VerifyWhatWeOffer = ({ sectionData, onSave, onBrowseLibrary }) => {
  const [isEditing, setIsEditing] = useState(false);
  const [showReference, setShowReference] = useState(false);
  const fileInputsRef = useRef({});

  console.log("VerifyWhatWeOffer sectionData:", sectionData);
  ...
  React.useEffect(() => {
    console.log('📌 VerifyWhatWeOffer received sectionData:', sectionData);
                  ...
                  try {
                    ...
                    for (const key of iconKeys) {
                      ...
                      if (file && file instanceof File) {
                        ...
                        const res = await uploadAPI.uploadImage(file, 'tvgEffect', 'tvg-verify');
                    ...
                    console.log('💾 VerifyWhatWeOffer final payload:', payload);
...
export default VerifyWhatWeOffer;
