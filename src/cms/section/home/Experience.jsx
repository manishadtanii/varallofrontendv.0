...
const Experience = ({ sectionData, onSave }) => {
  ...
  const [content, setContent] = useState({
    heading: sectionData?.heading || "Decades of Experience.\nOne Trusted Team.",
    subheading: sectionData?.subheading || "Delivering Solutions to Court Reporting Firms Across the U.S.",
    subtext: sectionData?.subtext || "Delivering Solutions to Court Reporting Firms Across the U.S. Backed by over 50 years of leadership and expertise in the court reporting industry, The Varallo Group combines a rich legacy, unwavering commitment, and forward-thinking innovation to empower and support your firm every step of the way.",
    mainImage: sectionData?.mainImage || "./about-home.png",
    subSecTitle: sectionData?.subSecTitle || "What Sets Us Apart",
    subSecPera: sectionData?.subSecPera || "Our handpicked team draws from decades of experience, delivering service with precision and professionalism. Think of us as a trusted extension of your team, dedicated to driving results together.",
    // Card 1
    c1_title: sectionData?.c1_title || "Technology-Driven",
    c1_desc: sectionData?.c1_desc || "We leverage advanced tools to streamline scheduling, delivery, and communication so you can scale with confidence.",
    c1_img: sectionData?.c1_img || "./ab-1.png",
    // Card 2
    c2_title: sectionData?.c2_title || "Confidential & Reliable",
    c2_desc: sectionData?.c2_desc || "We recognize the trust you’ve placed in us, and we’re dedicated to protecting the confidentiality of your private company information.",
    c2_img: sectionData?.c2_img || "./ab-2.png",
    // Card 3
    c3_title: sectionData?.c3_title || "People First",
    c3_desc: sectionData?.c3_desc || "It’s not just what we do, it’s about the people we serve. Our dedicated team brings genuine passion to help your business thrive and succeed.",
