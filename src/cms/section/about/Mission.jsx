...
const Hero = ({ sectionData, onSave }) => {
  ...
  const [content, setContent] = useState({
    heading: sectionData?.heading || "Shaping the Future",
    subtext1: sectionData?.subtext1 || "We strive to be the trusted partner powering the court reporting community with an expert team and scalable support.",
    subtext2: sectionData?.subtext2 || "We’re building a future where every firm, big or small, has access to proven solutions backed by experience. Through smart tech and passionate people, we’re supporting the industry, one partnership at a time.",
