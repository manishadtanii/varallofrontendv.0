...
const Hero = ({ sectionData, onSave }) => {
  ...
  const [content, setContent] = useState({
    ...
    subtext: sectionData?.subtext || "Rooted in a legacy of court reporting since 1937, The Varallo Group blends time-honored values with modern innovation to protect, preserve, and elevate the legal record.",
