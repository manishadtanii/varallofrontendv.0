...
const StreamManagement = ({ sectionData, onSave, onBrowseLibrary }) => {
  ...
  React.useEffect(() => {
    console.log('📌 StreamManagement received sectionData:', sectionData);
              ...
              <button
                onClick={async () => {
                  try {
                    ...
                    console.log('💾 StreamManagement final payload (after uploads):', payload);
