...
const Dashboard = () => {
  ...
  const renderActiveEditor = () => {
    ...
    switch (activeId) {
      ...
      case "Reporting Service Overview":
        return (
      ...
      case "Reporting What We Provide":
        return (
        ...
        <div className="w-80 flex flex-col gap-4 sticky top-6">
          <div className="bg-[#0a0f14]/80 border border-gray-800 rounded-[30px] p-6 h-[calc(100vh-48px)] overflow-y-auto custom-scrollbar">
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("home")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "home"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
                ...
                <div className="ml-9 mt-2 flex flex-col gap-1 border-l border-gray-800">
                  {[
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-2 text-xs font-medium transition-all ${activeId === sec && activePage === "home"
                          ? "text-cyan-400 border-l-2 border-cyan-400 -ml-[2px]"
                          : "text-gray-500 hover:text-white"
                        }`}
                    >
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("about")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "about"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
                ...
                <div className="ml-9 mt-2 flex flex-col gap-1 border-l border-gray-800">
                  {[
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-2 text-xs font-medium transition-all ${activeId === sec && activePage === "about"
                          ? "text-cyan-400 border-l-2 border-cyan-400 -ml-[2px]"
                          : "text-gray-500 hover:text-white"
                        }`}
                    >
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("service")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "services"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
                ...
                <div className="ml-9 mt-2 flex flex-col gap-1 border-l border-gray-800">
                  {[
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-2 text-xs font-medium transition-all ${activeId === sec && activePage === "services"
                          ? "text-cyan-400 border-l-2 border-cyan-400 -ml-[2px]"
                          : "text-gray-500 hover:text-white"
                        }`}
                    >
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("contact")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "contact"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
                ...
                <div className="ml-9 mt-2 flex flex-col gap-1 border-l border-gray-800">
                  {[
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-2 text-xs font-medium transition-all ${activeId === sec && activePage === "contact"
                          ? "text-cyan-400 border-l-2 border-cyan-400 -ml-[2px]"
                          : "text-gray-500 hover:text-white"
                        }`}
                    >
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("management")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${(activePage && activePage.startsWith('tvg-'))
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
                ...
                <div className="ml-9 mt-2 flex flex-col gap-1 border-l border-gray-800">
                  {[
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-2 text-xs font-medium transition-all ${activeId === sec &&
                          activePage === "tvg-management"
                          ? "text-cyan-400 border-l-2 border-cyan-400 -ml-[2px]"
                          : "text-gray-500 hover:text-white"
                        }`}
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("stream")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "services/tvg-stream"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
                ...
                <div className="ml-9 mt-2 flex flex-col gap-1 border-l border-gray-800">
                  {[
                    ...
                    <button
                      ...
                      className={`text-left px-4 py-2 text-xs font-medium transition-all ${activeId === sec.id &&
                          activePage === "services/tvg-stream"
                          ? "text-cyan-400 border-l-2 border-cyan-400 -ml-[2px]"
                          : "text-gray-500 hover:text-white"
                        }`}
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("books")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "services/tvg-books"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
            ...
            <div className="mb-2">
              <button
                onClick={() => toggle("connect")}
                className={`w-full flex items-center justify-between p-3 rounded-xl border ${activePage === "services/tvg-connect"
                    ? "bg-cyan-500/10 text-cyan-400 border-cyan-500/20"
                    : "text-gray-400 border-transparent"
                  }`}
              >
